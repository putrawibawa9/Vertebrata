                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <button class="btn btn-primary btn-sm mt-2" data-nama_hewan="<?= $row['nama_hewan']?>" data-keterangan_hewan="<?= $row['keterangan_hewan']?>" data-gambar="<?= $row['gambar']?>" data-kategori="$row['nama_kategori']?>"> Detail</button>
                            </div>
                        </div>
                    </div>
