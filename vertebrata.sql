...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2024 at 03:07 AM
...
(1, 'Kucing hitam', 'Ini Kucing hitam', '65ac7bab18666.png', 1);
...
--
ALTER TABLE `binatang`
  MODIFY `id_binatang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
